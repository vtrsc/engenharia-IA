...
class OpenAIAgentsTracingProcessor {
    ...
    async onTraceStart(trace) {
        ...
        Object.assign(mergedMetadata, (0, ls_agent_type_js_1.defaultLsAgentTypeMetadata)(mergedMetadata, currentRunTree));
        const runExtra = { metadata: mergedMetadata };
    ...
    async onSpanStart(span) {
        ...
        if (spanData.type === "agent") {
            ...
            if (parentSpanType === "function") {
                ...
                const meta = childRun.extra.metadata;
                if (!ls_agent_type_js_1.NON_ROOT_LS_AGENT_TYPES.has(meta.ls_agent_type)) {
