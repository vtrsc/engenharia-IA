...
import { NON_ROOT_LS_AGENT_TYPES, defaultLsAgentTypeMetadata, } from "../utils/ls_agent_type.js";
...
export class OpenAIAgentsTracingProcessor {
    ...
    async onTraceStart(trace) {
        ...
        Object.assign(mergedMetadata, defaultLsAgentTypeMetadata(mergedMetadata, currentRunTree));
    ...
    async onSpanStart(span) {
        ...
        if (spanData.type === "agent") {
            ...
            if (parentSpanType === "function") {
                ...
                if (!NON_ROOT_LS_AGENT_TYPES.has(meta.ls_agent_type)) {
