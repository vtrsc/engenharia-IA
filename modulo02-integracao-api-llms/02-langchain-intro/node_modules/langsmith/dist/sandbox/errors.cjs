 ...
 */
class LangSmithStreamEndedBeforeStartedError extends LangSmithSandboxOperationError {
    constructor(message) {
        super(message, "command");
        this.name = "LangSmithStreamEndedBeforeStartedError";
    }
}
exports.LangSmithStreamEndedBeforeStartedError = LangSmithStreamEndedBeforeStartedError;
/**
