...
export declare class SandboxClient {
     ...
     * @returns Snapshot in "ready" status.
     */
    createSnapshotFromDockerfile(name: string, dockerfile: string, fsCapacityBytesOrOptions?: number | CreateDockerfileSnapshotOptions, options?: CreateDockerfileSnapshotOptions): Promise<Snapshot>;
    /**
