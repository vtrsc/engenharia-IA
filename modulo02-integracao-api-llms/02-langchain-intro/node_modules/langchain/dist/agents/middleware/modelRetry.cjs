...
*/
const ModelRetryMiddlewareOptionsSchema = zod_v3.z.object({ 
/**
		...
		wrapModelCall: async (request, handler) => {
			...
			for (let attempt = 0; attempt <= maxRetries; attempt++) try {
				...
				if (attempt < maxRetries) {
					const delay = require_utils.calculateRetryDelay(delayConfig, attempt, require_utils.getRetryAfterMs(err));
...
//#endregion
exports.ModelRetryMiddlewareOptionsSchema = ModelRetryMiddlewareOptionsSchema;
