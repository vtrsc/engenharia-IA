...
*/
function calculateRetryDelay(config, retryNumber, retryAfterMs) {
...
function getRetryAfterMs(error) {
	...
	return typeof retryAfterMs === "number" && retryAfterMs >= 0 ? retryAfterMs : void 0;
}
//#endregion
export { calculateRetryDelay, countTokensApproximately, getHookConstraint, getHookFunction, getRetryAfterMs, sleep };
