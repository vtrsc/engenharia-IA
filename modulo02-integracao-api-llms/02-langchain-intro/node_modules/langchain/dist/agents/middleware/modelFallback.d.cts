 ...
 */
...fallbackModels: (string | AgentLanguageModelLike)[]): AgentMiddleware<undefined, undefined, unknown, readonly (import("@langchain/core/tools").ServerTool | import("@langchain/core/tools").ClientTool)[], readonly []>;
//#endregion
