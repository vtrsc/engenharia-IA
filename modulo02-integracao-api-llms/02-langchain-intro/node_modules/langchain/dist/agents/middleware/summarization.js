...
async function createSummary(messagesToSummarize, model, summaryPrompt, tokenCounter, trimTokensToSummarize, runtime) {
	...
	*/
	...
	try {
		...
		const config = mergeConfigs(pickRunnableConfigKeys(runtime) ?? {}, {
...
//#endregion
export { DEFAULT_SUMMARY_PROMPT, contextSizeSchema, getProfileLimits, keepSchema, summarizationMiddleware };
