...
declare function piiMiddleware(piiType: BuiltInPIIType | string, options?: {
  ...
  applyToOutput?: boolean | undefined;
  applyToToolResults?: boolean | undefined;
}, readonly (import("@langchain/core/tools").ServerTool | import("@langchain/core/tools").ClientTool)[], readonly []>;
//#endregion
export { BuiltInPIIType, Detector, PIIDetectionError, PIIDetector, PIIMatch, PIIMiddlewareConfig, PIIStrategy, RedactionRuleConfig, ResolvedRedactionRule, applyStrategy, detectCreditCard, detectEmail, detectIP, detectMacAddress, detectUrl, piiMiddleware, resolveRedactionRule };
