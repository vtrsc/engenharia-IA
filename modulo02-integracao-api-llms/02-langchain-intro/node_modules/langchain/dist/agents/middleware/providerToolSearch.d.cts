...
import { ClientTool, ServerTool, StructuredToolInterface } from "@langchain/core/tools";
//#region src/agents/middleware/providerToolSearch.d.ts
type ToolName = string;
type ToolIdentifier = ToolName | StructuredToolInterface;
 ...
 */
declare function providerToolSearchMiddleware(config?: ProviderToolSearchMiddlewareConfig): AgentMiddleware<undefined, undefined, unknown, readonly (ServerTool | ClientTool)[], readonly []>;
//#endregion
export { ProviderToolSearchMiddlewareConfig, ToolIdentifier, providerToolSearchMiddleware };
//# sourceMappingURL=providerToolSearch.d.cts.map