		...
		wrapToolCall: async (request, handler) => {
			...
			for (let attempt = 0; attempt <= maxRetries; attempt++) try {
				...
				if (attempt < maxRetries) {
					const delay = require_utils.calculateRetryDelay(delayConfig, attempt, require_utils.getRetryAfterMs(error));
...
//#endregion
exports.ToolRetryMiddlewareOptionsSchema = ToolRetryMiddlewareOptionsSchema;
