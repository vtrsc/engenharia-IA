import { calculateRetryDelay, getRetryAfterMs, sleep } from "./utils.js";
...
*/
const ModelRetryMiddlewareOptionsSchema = z.object({ 
/**
		...
		wrapModelCall: async (request, handler) => {
			...
			for (let attempt = 0; attempt <= maxRetries; attempt++) try {
				...
				if (attempt < maxRetries) {
					const delay = calculateRetryDelay(delayConfig, attempt, getRetryAfterMs(err));
...
//#endregion
export { ModelRetryMiddlewareOptionsSchema, modelRetryMiddleware };
