...
var Pregel = class extends PartialRunnable {
	...
	*/
	async stream(input, options) {
		...
		const ambientConfigurable = require_config.getConfig()?.configurable;
...
function _getTracingMetadataDefaults(config) {
	...
	for (const [key, value] of Object.entries(configurable)) {
		if (context != null && Object.prototype.hasOwnProperty.call(context, key) && Object.is(context[key], value)) {
			if (!key.startsWith("__")) metadata[key] = void 0;
			continue;
		}
