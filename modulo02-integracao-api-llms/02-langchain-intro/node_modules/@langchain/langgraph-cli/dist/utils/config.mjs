...
const API_VERSION_PATTERN = /^\d+(?:\.\d+){0,2}(?:(?:-[0-9A-Za-z]+(?:\.[0-9A-Za-z]+)*)|(?:[A-Za-z][0-9A-Za-z.-]*))?$/;
...
const BaseConfigSchema = z.object({
    ...
    api_version: z
        ...
        message: "api_version must be in format major, major.minor, or major.minor.patch with optional prerelease suffix",
    })
        .optional(),
    env: z
...
const NodeConfigSchema = BaseConfigSchema.merge(z.object({
