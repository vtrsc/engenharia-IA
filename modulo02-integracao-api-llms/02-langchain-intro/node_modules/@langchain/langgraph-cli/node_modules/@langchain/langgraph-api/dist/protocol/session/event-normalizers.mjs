 ...
 */
export const normalizeUpdatesData = (value) => {
    if (isRecord(value)) {
...
export const normalizeInputRequestedData = (value) => asInterruptArray(value).flatMap((entry) => {
...
export const stripInterruptsFromValues = (value) => {
 ...
 */
export const getToolCallId = (value, fallbackToolCallId) => {
 ...
 */
export const normalizeToolData = (value, fallbackToolCallId) => {
    ...
    switch (value.event) {
        ...
        case "on_tool_event":
            return {
                event: "tool-output-delta",
                tool_call_id: toolCallId,
                delta: typeof value.data === "string"
                    ? value.data
