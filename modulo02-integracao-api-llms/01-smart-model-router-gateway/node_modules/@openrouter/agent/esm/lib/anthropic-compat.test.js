...
describe('fromClaudeMessages', () => {
    ...
    describe('image blocks', () => {
        it('converts user image blocks to EasyInputMessage with array content', () => {
            const claudeMessages = [
                {
                    role: 'user',
                    content: [
        ...
        it('preserves assistant role for messages with images', () => {
            const claudeMessages = [
                {
                    role: 'assistant',
                    content: [
                        {
                            type: 'text',
                            text: 'Here is an image I generated:',
                        },
                        {
                            type: 'image',
                            source: {
