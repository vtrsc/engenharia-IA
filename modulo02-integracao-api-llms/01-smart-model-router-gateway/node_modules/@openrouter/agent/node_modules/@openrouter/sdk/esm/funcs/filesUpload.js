 ...
 */
import { appendForm, encodeFormQuery, encodeSimple, normalizeBlob, } from "../lib/encodings.js";
...
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => operations.UploadFileRequest$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
